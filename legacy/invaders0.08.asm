...
*
* Invaders.asm V0.08 by Allen C. Huffman
...
* Title screen stuff
 ...
 lbsr getkey        quit from title screen
 cmpa #'q
 lbeq shutdown
...
helpmsg fcb $d,$a
 fcc "Invaders 0.08 by Allen Huffman (coco-sysop@genie.geis.com)"
 fcb $d,$a
 ...
 fcb $d,$a
 fcc "        -j = use left port joystick (default is keyboard)."
 fcb $d,$a
