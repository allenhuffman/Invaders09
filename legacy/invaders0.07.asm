...
*
* Invaders.asm V0.07 by Allen C. Huffman
...
* 0.07 09/03/94 - Shot control, round boundries, NitrOS9 auto sensing
*
...
Y equ 3*80*20
Z equ 4*80*20
EDELAY equ 50       enemy movement delay (speed)
ADELAY equ 5        enemy animation delay
UFODELAY equ 5      ufo delay
COUNTER equ 2       ENEMIES/EDELAY+1
BORDER equ %01101001
BOTROW equ 181      bottom row of playfield
BDELAY equ 42       enemy bomb delay value
...
getloop lda <path   read one key from path
 ldb #1
...
helpmsg fcb $d,$a
 fcc "Invaders 0.07 by Allen Huffman of Sub-Etha Software (coco-sysop@genie.geis.com)"
 fcb $d,$a
 fcc "Use LEFT/RIGHT to Move, SPACE to Fire, Q to Quit."
 fcb $d,$a,$d,$a
