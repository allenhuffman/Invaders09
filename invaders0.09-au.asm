...
*
* Invaders.asm V0.09 by Allen C. Huffman
...
helpmsg fcb $d,$a
 fcc "Invaders 0.09 by Allen Huffman (coco-sysop@genie.geis.com)"
 fcb $d,$a
...
title 
 ...
 fcc "THIS PRE-RELEASE COPY DISTRIBUTED BY"
 fcb $2,$20+2,$20+17
 fcc "REMCON, Sub-Etha's Australian Dealer"
 fcb $2,$20+4,$20+23
